 ...
 */
public class ViewThemNhanhChatLieu extends javax.swing.JFrame {

    private List<ChatLieu> listCL=new ArrayList<>();
    private ChatLieuService chatLieuService=new ChatLieuServiceImpl();
    /**
     * Creates new form ViewThemNhanhChatLieu
     */
    public ViewThemNhanhChatLieu() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThemNhanhChatLieu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewThemNhanhChatLieu().setVisible(true);
            }
        });
    }
