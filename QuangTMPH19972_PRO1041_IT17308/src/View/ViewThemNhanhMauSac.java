 ...
 */
public class ViewThemNhanhMauSac extends javax.swing.JFrame {

    private List<MauSac> listMS=new ArrayList<>();
    private MauSacService mauSacService=new MauSacServiceImpl();
    /**
     * Creates new form ViewThemNhanhMauSac
     */
    public ViewThemNhanhMauSac() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThemNhanhMauSac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewThemNhanhMauSac().setVisible(true);
            }
        });
    }
