 ...
 */
public class ViewThemNhanhKichCo extends javax.swing.JFrame {

    private List<KichCo> listKC=new ArrayList<>();
    private KichCoService kichCoService=new KichCoServiceImpl();
    /**
     * Creates new form ViewThemNhanhKichCo
     */
    public ViewThemNhanhKichCo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThemNhanhKichCo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewThemNhanhKichCo().setVisible(true);
            }
        });
    }
